...
bash scripts/run_cujson_fig14.sh

# Step 2: Run simdjson
echo "▶️  [2/4] Running simdjson benchmark..."
bash scripts/run_simdjson_fig14.sh

# Step 3: Run RapidJSON
echo "▶️  [3/4] Running RapidJSON benchmark..."
bash scripts/run_rapidjson_fig14.sh

# Step 3: Run RapidJSON
echo "▶️  [3/4] Running pison benchmark..."
bash scripts/run_pison_fig14.sh

# Step 4: Merge all results
echo "🧩 [4/4] Merging CSV files..."
bash scripts/merge_fig14_csvs.sh
