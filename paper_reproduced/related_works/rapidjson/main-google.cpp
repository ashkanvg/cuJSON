...
int main() {
    ...
    FILE* fp = fopen("/home/csgrads/aveda002/Desktop/CUDA-Test/JSONPARSING/Test-Files/Pison_Large_Datasets/google_map_large_record.json", "r");
    ...
    // printMemoryUsage("Final"); // Print memory usage after deallocation
